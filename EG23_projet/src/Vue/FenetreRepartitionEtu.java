...
public class FenetreRepartitionEtu {

	private JFrame frameRepartitionEtu;

	/**
	 * Launch the application.
	 */
	public static void ouvreRepartitionEtu() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FenetreRepartitionEtu window = new FenetreRepartitionEtu();
					window.frameRepartitionEtu.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 */
	public FenetreRepartitionEtu() {
		initialize();
	}

	/**
	 * Initialize the contents of the frameRepartitionEtu.
	 */
	private void initialize() {
		frameRepartitionEtu = new JFrame();
		frameRepartitionEtu.setBounds(100, 100, 1096, 758);
		frameRepartitionEtu.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frameRepartitionEtu.getContentPane().setLayout(null);
		
		JPanel panel_menu = new JPanel();
		panel_menu.setBounds(0, 104, 261, 528);
		panel_menu.setBackground(new Color(255, 153, 0));
		frameRepartitionEtu.getContentPane().add(panel_menu);
		...
		btnGestionEnseignants.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frameRepartitionEtu.setVisible(false);
		...
		btnRepartitionEtu.setForeground(Color.BLUE);
		...
		frameRepartitionEtu.getContentPane().add(panel_header);
		...
		JLabel lbtnTexte = new JLabel("Répartition des étudiants");
		...
		frameRepartitionEtu.getContentPane().add(lbtnTexte);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(285, 141, 772, 555);
		frameRepartitionEtu.getContentPane().add(scrollPane);
		
		JPanel panel = new JPanel();
		scrollPane.setViewportView(panel);
		panel.setLayout(new GridLayout(0, 1, 0, 0));
		
		JLabel lblEffectif1 = new JLabel("");
		lblEffectif1.setVerticalAlignment(SwingConstants.TOP);
		ImageIcon effectif = new ImageIcon(FenetreGestionEnseignants.class.getResource("/imgs/repartitionEffectif.png"));
	    ImageIcon newEffectif = new ImageIcon((effectif).getImage().getScaledInstance(743,490, Image.SCALE_SMOOTH)); 
	  	lblEffectif1.setIcon(newEffectif);
		panel.add(lblEffectif1);
		
		JLabel lblEffectif2 = new JLabel("");
		lblEffectif2.setVerticalAlignment(SwingConstants.BOTTOM);
		ImageIcon effectif2= new ImageIcon(FenetreGestionEnseignants.class.getResource("/imgs/repartitionEffectif2.png"));
	    ImageIcon newEffectif2 = new ImageIcon((effectif2).getImage().getScaledInstance(745,490, Image.SCALE_SMOOTH)); 
	  	lblEffectif2.setIcon(newEffectif2);
		panel.add(lblEffectif2);
